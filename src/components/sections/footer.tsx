          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
                ...
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M4.478 2C3.11 2 2 3.11 2 4.478v11.044C2 16.89 3.11 18 4.478 18h11.044C16.89 18 18 16.89 18 15.522V4.478C18 3.11 16.89 2 15.522 2H4.478zM10 5.957A4.043 4.043 0 1014.043 10 4.043 4.043 0 0010 5.957zm0 1.5A2.543 2.543 0 1012.543 10 2.543 2.543 0 0010 7.457zm5.155-1.871a.968.968 0 11-1.936 0 .968.968 0 011.936 0z" clipRule="evenodd" />
                </svg>
              </a>
            </div>
          </div>

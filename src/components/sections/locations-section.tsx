...
const locationsData: Location[] = [
  {
    ...
    getDirectionsUrl: "https://www.google.com/maps/dir/?api=1&destination=Merrilville%2C%20IN",
    addressLines: ["Merrilville, IN"],
    phone: "(219) 555-0001",
    phoneHref: "tel:+12195550001",
    ...
    orderOnlineUrl: "https://sharkfishchicken.com/menu/sharksfishchicken-merrilville",
  },
  {
    name: "Lancing",
    slug: "lancing",
    fullName: "Sharks Fish & Chicken Lancing, IL",
    locationUrl: "https://sharkfishchicken.com/sharksfishandchicken-lancing",
    getDirectionsUrl: "https://www.google.com/maps/dir/?api=1&destination=Torrence%20Avenue%2C%20Lancing%2C%20IL",
    addressLines: ["Torrence Avenue", "Lancing, IL"],
    phone: "(708) 555-0002",
    ...
    orderOnlineUrl: "https://sharkfishchicken.com/menu/sharksfishandchicken-lancing",
  },
  {
    name: "Sauk Village",
    slug: "sauk-village",
    ...
    getDirectionsUrl: "https://www.google.com/maps/dir/?api=1&destination=Sauk%20Trail%2C%20Sauk%20Village%2C%20IL",
    ...
    orderOnlineUrl: "https://sharkfishchicken.com/menu/sharksfishchicken-sauk-village",
  },
];
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div>
                  ...
                  <a href={activeLocation.getDirectionsUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-start gap-2 p-3 bg-muted/50 rounded-lg hover:bg-primary/10 hover:text-primary transition-colors group">
                    <div>
                      {activeLocation.addressLines.map((line, index) => (
                        <span key={index} className="block text-muted-foreground group-hover:text-primary">{line}</span>
                      ))}
                      <span className="text-xs text-primary mt-1 opacity-0 group-hover:opacity-100 transition-opacity">Click for directions →</span>
                    </div>
                  </a>
                </div>
                <div>
                  ...
                  <div className="space-y-2">
                    <a href={activeLocation.phoneHref} className="flex items-center gap-2 p-3 bg-muted/50 rounded-lg hover:bg-primary/10 hover:text-primary transition-colors group">
                      <svg className="w-4 h-4 text-muted-foreground group-hover:text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                      <span className="text-muted-foreground group-hover:text-primary">{activeLocation.phone}</span>
                    </a>
                    <a href={activeLocation.emailHref} className="flex items-center gap-2 p-3 bg-muted/50 rounded-lg hover:bg-primary/10 hover:text-primary transition-colors group">
                      <svg className="w-4 h-4 text-muted-foreground group-hover:text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                      <span className="text-muted-foreground group-hover:text-primary">{activeLocation.email}</span>
                    </a>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between py-2 px-4 bg-muted/50 rounded-lg">
                    <div className="font-medium text-foreground">Sunday - Thursday</div>
                    <div className="text-muted-foreground">10:00 AM - 12:00 AM</div>
                  </div>
                  <div className="flex items-center justify-between py-2 px-4 bg-muted/50 rounded-lg">
                    <div className="font-medium text-foreground">Friday - Saturday</div>
                    <div className="text-muted-foreground">10:00 AM - 2:00 AM</div>
                  </div>
                </div>

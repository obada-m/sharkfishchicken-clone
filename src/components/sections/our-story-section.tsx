        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
              Born from Passion, Serving Indiana Communities with Pride
            </p>
          </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Fresh ingredients and authentic preparation in every meal, ensuring 
                      the same great taste and quality every single time.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Serving our Indiana neighbors with pride and dedication, being part of 
                      special family moments and everyday celebrations.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Continuously improving our recipes and service while maintaining 
                      the traditions that made us a local favorite.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="text-center">
            <div className="bg-white rounded-lg p-8 shadow-lg max-w-4xl mx-auto">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Serving Three Locations Across Indiana
              </h3>

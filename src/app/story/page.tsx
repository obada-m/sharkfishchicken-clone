      ...
      <main className="container mx-auto px-4 py-8">
                ...
                <div className="flex items-center justify-center mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    {/* <div className="flex flex-col text-left">
                      <span className="text-4xl font-bold text-gray-900">Sharks</span>
                      <span className="text-2xl text-gray-700 -mt-1">Fish & Chicken</span>
                    </div> */}
                  </div>
                </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      <strong>Quality First:</strong> Fresh ingredients and
                      authentic preparation in every meal
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Users className="h-5 w-5 text-blue-500 mt-1 flex-shrink-0" />
                    <span>
                      <strong>Community Focus:</strong> Serving our neighbors
                  ...
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      <strong>Excellence:</strong> Continuously improving our
                      recipes and service
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <span>
                      <strong>Consistency:</strong> The same great taste and
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="text-center hover:shadow-md transition-shadow">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">
                  Our proprietary blend of spices and seasonings, perfected over
                  years, creates the distinctive flavor that sets us apart from
                  the rest.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-md transition-shadow">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">
                  Our menu features a carefully chosen selection of seafood,
                  including catfish, ocean perch, tilapia, jack salmon and
                  shrimp. We prepare each piece with the same dedication and
                  attention to detail as our famous chicken.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center hover:shadow-md transition-shadow">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">
                  Each piece is hand-seasoned and cooked to golden perfection,
                  ensuring that crispy exterior and juicy interior in every
                  single bite.
                </p>
              </CardContent>
            </Card>
        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-3xl mx-auto bg-gradient-to-r from-blue-50 to-teal-50 rounded-lg p-8">
            <p className="text-lg leading-relaxed text-gray-700 mb-6">
              Every time you visit Sharks Fish & Chicken, you can expect the
              same commitment to quality, freshness, and flavor that we've
              maintained since day one. We use only the finest ingredients,
              prepare everything fresh daily, and never compromise on the
              standards that made us who we are today.
            </p>
        ...
        <div className="text-center bg-gradient-to-r from-teal-600 to-blue-600 text-white rounded-lg p-8">
          <h2 className="text-3xl font-bold mb-4">
            Experience the Sharks Difference
          </h2>
          <p className="text-lg mb-6 opacity-90">
            Ready to taste what makes us special? Visit one of our locations or
            order online today.
          </p>

      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Find a Sharks Fish & Chicken location near you. We're proud to serve delicious fried chicken and fish across Illinois.
          </p>
        </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 rounded-lg p-3">
                    <p className="text-sm text-gray-600">
                      <span className="font-medium">Delivery Available:</span> Within {location.deliveryRadius} miles
                    </p>
                  </div>
        ...
        <div className="mt-16 text-center max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-blue-50 to-teal-50 rounded-lg p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Why Choose Sharks Fish & Chicken?</h2>
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div>
                <div className="text-3xl mb-2">🍗</div>
                <h3 className="font-semibold mb-2">Fresh Daily</h3>
                <p className="text-sm text-gray-600">All our chicken and fish is prepared fresh daily with our secret seasoning blend</p>
              </div>
              <div>
                <div className="text-3xl mb-2">🚗</div>
                <h3 className="font-semibold mb-2">Fast Service</h3>
                <p className="text-sm text-gray-600">Quick pickup, delivery, and dine-in options available at all locations</p>
              </div>
              <div>
                <div className="text-3xl mb-2">👨‍👩‍👧‍👦</div>
                <h3 className="font-semibold mb-2">Family Owned</h3>
                <p className="text-sm text-gray-600">Serving the Illinois community with pride for years with authentic flavors</p>
              </div>
            </div>
